...
export default function FeaturedProductCard(props) {
  return (
    <div className="flex w-1/2 cursor-pointer flex-col flex-nowrap rounded-[5px]  p-[5px] sm:w-1/3 lg:rounded-[10px] lg:p-[10px]">
